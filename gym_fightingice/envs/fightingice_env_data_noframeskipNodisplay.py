...
class FightingiceEnv_Data_NoFrameskipNodisplay(gym.Env):
    ...
    def _start_java_game(self):
        ...
        if self.system_name == "windows":
            ...
            self.java_env = subprocess.Popen(["java", "-Xms1024m", "-Xmx1024m", "-cp", self.start_up_str, "Main", "--port", str(self.port), "--py4j", "--disable-window", "--fastmode", "--err-log", 
